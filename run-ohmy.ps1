...
try {
    ...
    foreach ($key in @(
          ...
          'OPENROUTER_SITE_URL',
          'OPENROUTER_APP_NAME',
          'NOVA_CLASSIFIER_PRIMARY',
          'NOVA_PROVIDER_COOLDOWN_SECONDS',
          'NOVA_REQUEST_TIMEOUT_MS',
          'NOVA_CLASSIFIER_PROVIDER_TIMEOUT_MS',
          'NOVA_CLASSIFIER_STAGE_TIMEOUT_MS',
          'NOVA_GROUNDED_PROVIDER_TIMEOUT_MS',
          'GEMINI_VISION_MODEL',
            'GOOGLE_PLACES_API_KEY',

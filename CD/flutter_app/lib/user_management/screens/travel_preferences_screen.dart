...
class _TravelPreferencesScreenState extends State<TravelPreferencesScreen> {
  ...
  late final _service = TravelerProfileService();
    ...
    return PopScope<void>(
      ...
      onPopInvokedWithResult: (didPop, _) {
        if (didPop && widget.isEditing) {
          // Return a draft only. Edit Profile owns the database save action.
                                  ...
                                  LayoutBuilder(
                                    builder: (context, constraints) {
                                      ...
                                      return Wrap(
                                        ...
                                        runSpacing: 8,
                                        children:
                                            culturalTravelPreferenceOptions
                                                .map(
                                                  (interest) =>
                                                      _buildInterestChoice(
                                                        interest,
                                                        width,
                                                      ),
                                                )
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        Expanded(
                                          child: Text(
                                            widget.isEditing
                                                ? 'Go back, then tap Save Changes in Edit profile to save your selections.'

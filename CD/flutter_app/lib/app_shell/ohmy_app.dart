...
import '../community_discovery/ui/post_detail_screen.dart';
...
// Authenticated builds use the live Community Discovery repository so Home and
// Community always show the same posts. Offline/demo builds retain seed data.
...
class _OhMyShellState extends State<OhMyShell> {
  ...
  void initState() {
    ...
    _travelGroupController = TravelGroupController(
      ...
      currentUser: authUser == null ? null : _prototypeUser(authUser),
  ...
  void dispose() {
    ...
    _travelGroupController.dispose();
    ...
    return PrototypeUser(
      ...
      name:
          (metadata['username'] ??
              ...
              .toString(),
      isVerified:
          _bypassTravelGroupVerification ||
          user.appMetadata['is_verified'] == true,
    );
  }

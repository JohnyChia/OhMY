        ...
        if (controller.itinerary.isEmpty)
          ...
          ReorderableListView.builder(
            ...
            onReorder:
                ...
                ? (oldIndex, newIndex) {
                    // Flutter reports the insertion slot, so moving an item
                    // down shifts the destination index by one after removal.
                    final targetIndex =
                        newIndex > oldIndex ? newIndex - 1 : newIndex;
                    unawaited(controller.reorderStops(oldIndex, targetIndex));
                  }
                : (_, _) {},
